...
class Logging(BaseModel):
    ...
    driver: Optional[str]
    options: Optional[  # type: ignore [valid-type]
        Dict[constr(regex=r"^.+$"), Optional[Union[str, float]]]
    ]
...
class ListOrDict(BaseModel):
    __root__: Union[  # type: ignore [valid-type]
...
class Network(BaseModel):
    ...
    name: Optional[str]
    driver: Optional[str]
    driver_opts: Optional[  # type: ignore [valid-type]
        Dict[constr(regex=r"^.+$"), Union[str, float]]
    ]
    ipam: Optional[Ipam]
...
class Service(BaseModel):
    ...
    depends_on: Optional[  # type: ignore [valid-type]
    ...
    networks: Optional[  # type: ignore [valid-type]
        Union[
    ...
    tty: Optional[bool]
    ulimits: Optional[  # type: ignore [valid-type]
        Dict[constr(regex=r"^[a-z]+$"), Union[int, Ulimit]]
    ]
    user: Optional[str]
