...
from tests.e2e.utilities.consts import ExpectedNamedVolume, ExpectedMount
...
@dataclass
class OT3NamedVolumes:

    head: ExpectedNamedVolume
    gantry_x: ExpectedNamedVolume
    gantry_y: ExpectedNamedVolume
    gripper: ExpectedNamedVolume
    pipettes: ExpectedNamedVolume
