...
from tests.compose_file_creator.conftest import HEATER_SHAKER_MODULE_EMULATION_LEVEL
...
def test_default_heater_shaker(heater_shaker_model) -> None:
...
def test_heater_shaker_source_repos(heater_shaker_model) -> None:
